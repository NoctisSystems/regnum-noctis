...
export default function FormadorTicketDetalhePage() {
  ...
  async function carregarTudo() {
    ...
    try {
      ...
      const { data: ticketData, error: ticketError } = await supabase
        ...
        .select(
          "id, created_at, updated_at, tipo, estado, prioridade, razao, assunto, mensagem_inicial, aluno_id, curso_id, formador_id, formador_envolvido"
        )
        .eq("id", ticketId)
      ...
      <section style={{ maxWidth: "1180px", margin: "0 auto" }}>
        {loading ? (
          <Box>
            ...
            <p style={textoBase}>
              Estamos a reunir o histórico do ticket em que foste envolvido.
            </p>
          </Box>
        ) : erro && !ticket ? (
          <ErrorBox texto={erro} />
          ...
          <>
            <Box>
              ...
              >
                ...
                <Link href="/formadores/tickets" style={botaoSecundario}>
                  Voltar aos tickets
                </Link>
              </div>
            ...
            >
              ...
              <Box>
                <h2 style={tituloSecao}>Responder no ticket</h2>
                ...
                <div style={{ display: "grid", gap: "14px" }}>
                  <textarea
                    ...
                    rows={8}
                    placeholder="Escreve aqui a tua resposta para a administração e para o aluno."
                    style={textareaStyle}
                  />
